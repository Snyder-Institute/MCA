...
<div class="lit-wrap">
    ...
    <p style="color: #555; font-size: 15px; line-height: 1.65; margin: 0 0 12px;">
        All <?php echo count($papers); ?> papers curated into MCA, ordered by year of publication. Each entry links to the original record on PubMed.
    </p>
    <p style="color: #555; font-size: 15px; line-height: 1.65; margin: 0 0 24px;">
        We thank the authors and research teams whose published work forms the evidence base of the Microbial Clinical Atlas. MCA is a derivative resource — every clinical claim ultimately rests on the primary studies cited below.
    </p>
