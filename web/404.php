...
<div class="page-content" style="text-align: center; padding-top: 80px;">
    ...
    <p style="color: #666; max-width: 560px; margin: 0 auto 24px; line-height: 1.6;">
        ...
        No worries &mdash; you can search below, browse the
...
(function () {
    ...
    // Cancel auto-redirect if the user starts interacting with the search box.
    const searchInput = document.getElementById('microbe-search');
    if (searchInput) {
        searchInput.addEventListener('focus', () => {
            clearInterval(tick);
            const note = document.querySelector('#countdown');
