...
│   ├── MCA_DB_v1_10_20260403.sql.gz # Current SQL dump (generated by xml2sql.py)
...
2. Import data: `gunzip -c database/MCA_DB_v1_10_20260403.sql.gz | mysql MCA`
...
5. To regenerate the SQL dump from XML: `python3 database/xml2sql.py database/MCA_DB_v1_10_20260403.xml` (outputs `.sql.gz` directly)
